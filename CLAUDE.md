...
- Performance budget: LCP < 1.2s on slow 4G, initial JS < 60KB gzipped (excluding lazily-imported WebLLM), Lighthouse 100/100 on the static shell. Anything that risks these needs a note in the proposal.
